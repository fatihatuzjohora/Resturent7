...
<div>
    <div className="mt-10 flex flex-col justify-center items-center max-w-3xl mx-auto text-center ">
        ...
        <p className="text-[#150B2B99] mt-3">One of the unfortunate things about disasters is that you never know when they are going to strike. But when they do, you’re suddenly in the middle of a very difficult situation.</p>
    </div>
    <div>

        <div><Card data={data} preparing={preparing} handleClick={handleClick} cook={cook} handlePreparing={handlePreparing}></Card></div>
